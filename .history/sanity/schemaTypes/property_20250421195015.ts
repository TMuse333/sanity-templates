  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'style', title: 'Style', type: 'string' }), // Note: also included in root below
      ],
    }),
    ...
    // Fields from hardcoded values now included in root:
    defineField({ name: 'status', title: 'Status', type: 'string' }),
    defineField({ name: 'mls', title: 'MLS Number', type: 'string' }),
    defineField({ name: 'style', title: 'Style (root)', type: 'string' }), // Potential duplication warning

...
<div className="bg-white shadow-md rounded-2xl p-6 w-full max-w-xl">
  ...
  <ul className="space-y-2 text-gray-700">
    <li><span className="font-medium">Address:</span> 60 Helen Creighton Court, Bedford, B4B 0Z5</li>
    <li><span className="font-medium">Status:</span> PENDING</li>
    <li><span className="font-medium">Listing Price:</span> $824,900</li>
    <li><span className="font-medium">MLS®:</span> 202507639</li>
    <li><span className="font-medium">Type:</span> Single Family</li>
    <li><span className="font-medium">Style:</span> Semi-Detached</li>
    <li><span className="font-medium">Age:</span> 3 years</li>
    <li><span className="font-medium">Square Footage (MLA):</span> 1,530 ft²</li>
    <li><span className="font-medium">Total Finished SqFt (TLA):</span> 2,980 ft²</li>
    <li><span className="font-medium">PID:</span> 41508821</li>
    <li><span className="font-medium">Bedrooms:</span> 4</li>
    <li><span className="font-medium">Full Baths:</span> 3</li>
    <li><span className="font-medium">Half Baths:</span> 0</li>
    <li><span className="font-medium">Water:</span> Municipal</li>
    <li><span className="font-medium">Sewer:</span> Municipal</li>
    <li><span className="font-medium">Utilities:</span> Cable, Electricity, High Speed Internet, Natural Gas</li>
  </ul>
</div>

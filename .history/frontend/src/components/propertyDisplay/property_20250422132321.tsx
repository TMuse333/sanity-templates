...
interface PropertyProps {
  ...
  // New props from hardcoded values
  status: string;
  mls: string;
  style: string;
  age: string;
  squareFootageMLA: string;
  totalFinishedSqFtTLA: string;
  pid: string;
  fullBaths: string;
  halfBaths: string;
  water: string;
...
const Property: React.FC<PropertyProps> = ({
  mainSrc, address, price, location, beds, bath, squareFt, propertyDescription, listingImages
}) => {
  return (

import { ThreeBoxHeroProps} from 'focusflow-components'
 ...
 export const heroData: ThreeBoxHeroProps = {
    h1: "The Focus Flow Property ploader",
    h2: "Realtors ,Generate a page for your property without writing code",
    pTag: "Fill out a form by clicking the button on the right then filling out the form, then checking "+
    "the page at focusflow-property-uploader/listing/[slug]",
    boxData: [
      {

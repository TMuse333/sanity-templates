...
export const heroData: ThreeBoxHeroProps = {
  ...
  export const closerData: VerticalImageTextBoxProps = {
    ...
    description: 'Skip the hassle and effortlessly upload your property with our intuitive platform. Save time and start showcasing your listings to potential buyers today.',
